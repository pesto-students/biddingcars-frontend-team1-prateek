      ...
      <>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            fullWidth
            variant="standard"
            onChange={()=>{setNewbid(event.target.value)}}
          />
        </DialogContent>
        <DialogActions>
        <Button
  ...
  const confirmbid = () => {
    return (
      <>
        ...
        <DialogContent>
          <DialogContentText>
            Please Confirm your bid amount and place the bid
          </DialogContentText>
          <br />
          <br />
          <DialogContentText>
    ...
    <div>
      <Box sx={{ display: "flex", flexWrap: "wrap" }}>
        ...
        >
          ...
          >
            ...
            <Box sx={carAttributes}>
              ...
              <Box sx={{ color: "text.primary" }}>
                {toIndianCurrency(car?.basePrice)}{" "}
              </Box>
            </Box>
            <Box sx={carAttributes}>
              <Box sx={{ color: "text.secondary" }}>Sticker Price</Box>
              <Box sx={{ color: "text.primary" }}>
                {toIndianCurrency(car?.fullPrice)}{" "}
              </Box>
            </Box>
          </Box>
        </Box>
        ...
        >
          ...
          >
            <Box sx={{ fontSize: "22px", color: "text.secondary", mb: "10px" }}>
              Description
            </Box>
            {car?.description}
          </Box>
