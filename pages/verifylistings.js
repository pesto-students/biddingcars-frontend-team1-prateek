...
export default function Verifylistings() {
  ...
  return !auth.authenticate ? (
    ...
    <div>
      ...
      <List sx={{display: '-webkit-box','&& .Mui-selected, && .Mui-selected:hover': {
            bgcolor: '#2979ff',
        ...
        <ListItem  disablePadding>
          <ListItemButton selected sx={{ textAlign: 'center' ,width:'204px'}} >
            <ListItemText primary= 'Cars to be verified'/>
          </ListItemButton>
        </ListItem>
